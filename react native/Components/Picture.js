...
const UploadImage =async()=>{
  let name1 = Math.random().toString(36).substring(7);
  
  let obj = {name:name1,folder:"userProfile",base64:Base64}

  let dataImage = await sql.UploadImage(obj)
          ...
          visible={Open}>
            <View style={{flex:1,justifyContent:'center',alignItems:'center',margin:20}}>
              <TouchableOpacity style={{margin:10}} onPress={()=>setOpen(false)}>
                ...
                <Button title="i love this photo" name="image" onPress={UploadImage} ></Button>
              </TouchableOpacity>
